import{f as l,j as s}from"./index-xNsX7Ar1.js";const c={title:"reth db get static-file",description:"undefined"};function a(e){const n={a:"a",code:"code",div:"div",h1:"h1",header:"header",p:"p",pre:"pre",span:"span",...l(),...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.header,{children:s.jsxs(n.h1,{id:"reth-db-get-static-file",children:["reth db get static-file",s.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#reth-db-get-static-file",children:s.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,s.jsx(n.p,{children:"Gets the content of a static file segment for the given key"}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsx(n.code,{children:s.jsxs(n.span,{className:"line",children:[s.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"$"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" reth"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" db"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" get"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" static-file"}),s.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --help"})]})})})}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(n.code,{children:[s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Usage: reth db get static-file [OPTIONS] <SEGMENT> <KEY>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Arguments:"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  <SEGMENT>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Possible values:"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - headers:      Static File segment responsible for the `CanonicalHeaders`, `Headers`, `HeaderTerminalDifficulties` tables"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - transactions: Static File segment responsible for the `Transactions` table"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - receipts:     Static File segment responsible for the `Receipts` table"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - block-meta:   Static File segment responsible for the `BlockBodyIndices`, `BlockOmmers`, `BlockWithdrawals` tables"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  <KEY>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          The key to get content for"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
