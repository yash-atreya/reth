import{f as l,j as s}from"./index-xNsX7Ar1.js";const c={title:"reth db",description:"undefined"};function a(e){const n={a:"a",code:"code",div:"div",h1:"h1",header:"header",p:"p",pre:"pre",span:"span",...l(),...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.header,{children:s.jsxs(n.h1,{id:"reth-db",children:["reth db",s.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#reth-db",children:s.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,s.jsx(n.p,{children:"Database debugging utilities"}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsx(n.code,{children:s.jsxs(n.span,{className:"line",children:[s.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"$"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" reth"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" db"}),s.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --help"})]})})})}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(n.code,{children:[s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Usage: reth db [OPTIONS] <COMMAND>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Commands:"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  stats     Lists all the tables, their entry count and their size"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  list      Lists the contents of a table"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  checksum  Calculates the content checksum of a table"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  diff      Create a diff between two database tables or two entire databases"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  get       Gets the content of a table for the given key"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  drop      Deletes all database entries"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  clear     Deletes all table entries"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  version   Lists current and local database versions"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  path      Returns the full database path"})}),`
