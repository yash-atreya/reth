import{f as l,j as s}from"./index-xNsX7Ar1.js";const c={title:"reth download",description:"undefined"};function a(e){const n={a:"a",code:"code",div:"div",h1:"h1",header:"header",p:"p",pre:"pre",span:"span",...l(),...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.header,{children:s.jsxs(n.h1,{id:"reth-download",children:["reth download",s.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#reth-download",children:s.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,s.jsx(n.p,{children:"Download public node snapshots"}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsx(n.code,{children:s.jsxs(n.span,{className:"line",children:[s.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"$"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" reth"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" download"}),s.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --help"})]})})})}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(n.code,{children:[s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Usage: reth download [OPTIONS]"})}),`
...
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  -u, --url <URL>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Specify a snapshot URL or let the command propose a default one."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Available snapshot sources:"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - https://downloads.merkle.io (default, mainnet archive)"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - https://publicnode.com/snapshots (full nodes & testnets)"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          If no URL is provided, the latest mainnet archive snapshot"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          will be proposed for download from merkle.io"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
