import{f as l,j as s}from"./index-xNsX7Ar1.js";const c={title:"reth db list",description:"undefined"};function a(e){const n={a:"a",code:"code",div:"div",h1:"h1",header:"header",p:"p",pre:"pre",span:"span",...l(),...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.header,{children:s.jsxs(n.h1,{id:"reth-db-list",children:["reth db list",s.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#reth-db-list",children:s.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,s.jsx(n.p,{children:"Lists the contents of a table"}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsx(n.code,{children:s.jsxs(n.span,{className:"line",children:[s.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"$"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" reth"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" db"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" list"}),s.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --help"})]})})})}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(n.code,{children:[s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Usage: reth db list [OPTIONS] <TABLE>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Arguments:"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  <TABLE>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          The table name"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Options:"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  -s, --skip <SKIP>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Skip first N entries"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          [default: 0]"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  -r, --reverse"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Reverse the order of the entries. If enabled last table entries are read"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  -l, --len <LEN>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          How many items to take from the walker"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          [default: 5]"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --search <SEARCH>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Search parameter for both keys and values. Prefix it with `0x` to search for binary data, and text otherwise."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          ATTENTION! For compressed tables (`Transactions` and `Receipts`), there might be missing results since the search uses the raw uncompressed value from the database."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --min-row-size <MIN_ROW_SIZE>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Minimum size of row in bytes"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          [default: 0]"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --min-key-size <MIN_KEY_SIZE>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Minimum size of key in bytes"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          [default: 0]"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --min-value-size <MIN_VALUE_SIZE>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Minimum size of value in bytes"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          [default: 0]"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  -c, --count"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Returns the number of rows found"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  -j, --json"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Dump as JSON instead of using TUI"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --raw"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Output bytes instead of human-readable decoded value"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
