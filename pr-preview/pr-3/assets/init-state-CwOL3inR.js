import{f as l,j as s}from"./index-xNsX7Ar1.js";const c={title:"reth init-state",description:"undefined"};function a(e){const n={a:"a",code:"code",div:"div",h1:"h1",header:"header",p:"p",pre:"pre",span:"span",...l(),...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.header,{children:s.jsxs(n.h1,{id:"reth-init-state",children:["reth init-state",s.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#reth-init-state",children:s.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,s.jsx(n.p,{children:"Initialize the database from a state dump file"}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsx(n.code,{children:s.jsxs(n.span,{className:"line",children:[s.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"$"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" reth"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" init-state"}),s.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --help"})]})})})}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(n.code,{children:[s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Usage: reth init-state [OPTIONS] <STATE_DUMP_FILE>"})}),`
...
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --without-evm"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Specifies whether to initialize the state without relying on EVM historical data."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          When enabled, and before inserting the state, it creates a dummy chain up to the last EVM block specified. It then, appends the first block provided block."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - **Note**: **Do not** import receipts and blocks beforehand, or this will fail or be ignored."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --header <HEADER_FILE>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Header file containing the header in an RLP encoded format."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --total-difficulty <TOTAL_DIFFICULTY>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Total difficulty of the header."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --header-hash <HEADER_HASH>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Hash of the header."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  <STATE_DUMP_FILE>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          JSONL file with state dump."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Must contain accounts in following format, additional account fields are ignored. Must"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:'          also contain { "root": \\<state-root\\> } as first line.'})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          {"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:'              "balance": "\\<balance\\>",'})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:'              "nonce": \\<nonce\\>,'})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:'              "code": "\\<bytecode\\>",'})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:'              "storage": {'})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:'                  "\\<key\\>": "\\<value\\>",'})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"                  .."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"              },"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:'              "address": "\\<address\\>",'})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          }"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Allows init at a non-genesis block. Caution! Blocks must be manually imported up until"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          and including the non-genesis block to init chain at. See 'import' command."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
