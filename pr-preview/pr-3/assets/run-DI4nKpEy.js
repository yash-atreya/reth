import{f as l,j as s}from"./index-xNsX7Ar1.js";const c={title:"reth stage run",description:"undefined"};function a(e){const n={a:"a",code:"code",div:"div",h1:"h1",header:"header",p:"p",pre:"pre",span:"span",...l(),...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.header,{children:s.jsxs(n.h1,{id:"reth-stage-run",children:["reth stage run",s.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#reth-stage-run",children:s.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,s.jsx(n.p,{children:"Run a single stage."}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsx(n.code,{children:s.jsxs(n.span,{className:"line",children:[s.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"$"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" reth"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" stage"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" run"}),s.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --help"})]})})})}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(n.code,{children:[s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Usage: reth stage run [OPTIONS] --from <FROM> --to <TO> <STAGE>"})}),`
...
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --from <FROM>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          The height to start at"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  -t, --to <TO>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          The end of the stage"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --batch-size <BATCH_SIZE>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Batch size for stage execution and unwind"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  -s, --skip-unwind"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Normally, running the stage requires unwinding for stages that already have been run, in order to not rewrite to the same database slots."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          You can optionally skip the unwinding phase if you're syncing a block range that has not been synced before."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  -c, --commit"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Commits the changes in the database. WARNING: potentially destructive."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Useful when you want to run diagnostics on the database."})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --checkpoints"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Save stage checkpoints"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  <STAGE>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          The name of the stage to run"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Possible values:"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - headers:         The headers stage within the pipeline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - bodies:          The bodies stage within the pipeline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - senders:         The senders stage within the pipeline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - execution:       The execution stage within the pipeline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - account-hashing: The account hashing stage within the pipeline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - storage-hashing: The storage hashing stage within the pipeline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - hashing:         The account and storage hashing stages within the pipeline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - merkle:          The merkle stage within the pipeline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - tx-lookup:       The transaction lookup stage within the pipeline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - account-history: The account history stage within the pipeline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          - storage-history: The storage history stage within the pipeline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
