import{f as l,j as s}from"./index-xNsX7Ar1.js";const r={title:"reth",description:"undefined"};function a(e){const n={a:"a",code:"code",div:"div",h1:"h1",header:"header",p:"p",pre:"pre",span:"span",...l(),...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.header,{children:s.jsxs(n.h1,{id:"reth",children:["reth",s.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#reth",children:s.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,s.jsx(n.p,{children:"Reth"}),`
...
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(n.code,{children:[s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Usage: reth [OPTIONS] <COMMAND>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Commands:"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  node          Start the node"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  init          Initialize the database from a genesis file"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  init-state    Initialize the database from a state dump file"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  import        This syncs RLP encoded blocks from a file"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  import-era    This syncs ERA encoded blocks from a directory"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  dump-genesis  Dumps genesis block JSON configuration to stdout"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  db            Database debugging utilities"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  download      Download public node snapshots"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  stage         Manipulate individual stages"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  p2p           P2P Debugging utilities"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  config        Write config to stdout"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  debug         Various debug routines"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  recover       Scripts for node recovery"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  prune         Prune according to the configuration without any limits"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  help          Print this message or the help of the given subcommand(s)"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
...
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  -V, --version"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Print version"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
...
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          Silence all log output"})})]})})})]})}function c(e={}){const{wrapper:n}={...l(),...e.components};return n?s.jsx(n,{...e,children:s.jsx(a,{...e})}):a(e)}export{c as default,r as frontmatter};
