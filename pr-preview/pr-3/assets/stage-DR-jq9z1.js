import{f as l,j as s}from"./index-xNsX7Ar1.js";const r={title:"reth stage",description:"undefined"};function a(e){const n={a:"a",code:"code",div:"div",h1:"h1",header:"header",p:"p",pre:"pre",span:"span",...l(),...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.header,{children:s.jsxs(n.h1,{id:"reth-stage",children:["reth stage",s.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#reth-stage",children:s.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,s.jsx(n.p,{children:"Manipulate individual stages"}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsx(n.code,{children:s.jsxs(n.span,{className:"line",children:[s.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"$"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" reth"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" stage"}),s.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --help"})]})})})}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(n.code,{children:[s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Usage: reth stage [OPTIONS] <COMMAND>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Commands:"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  run     Run a single stage"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  drop    Drop a stage's tables from the database"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  dump    Dumps a stage from a range into a new database"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  unwind  Unwinds a certain block range, deleting it from the database"})}),`
