import{f as l,j as s}from"./index-xNsX7Ar1.js";const c={title:"reth stage unwind",description:"undefined"};function a(e){const n={a:"a",code:"code",div:"div",h1:"h1",header:"header",p:"p",pre:"pre",span:"span",...l(),...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.header,{children:s.jsxs(n.h1,{id:"reth-stage-unwind",children:["reth stage unwind",s.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#reth-stage-unwind",children:s.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,s.jsx(n.p,{children:"Unwinds a certain block range, deleting it from the database"}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsx(n.code,{children:s.jsxs(n.span,{className:"line",children:[s.jsx(n.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"$"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" reth"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" stage"}),s.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" unwind"}),s.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --help"})]})})})}),`
`,s.jsx(s.Fragment,{children:s.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(n.code,{children:[s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Usage: reth stage unwind [OPTIONS] <COMMAND>"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"Commands:"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  to-block    Unwinds the database from the latest block, until the given block number or hash has been reached, that block is not included"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"  num-blocks  Unwinds the database from the latest block, until the given number of blocks have been reached"})}),`
...
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"      --offline"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{children:"          If this is enabled, then all stages except headers, bodies, and sender recovery will be unwound"})}),`
`,s.jsx(n.span,{className:"line",children:s.jsx(n.span,{})}),`
